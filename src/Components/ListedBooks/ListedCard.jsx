...
const ListedReadCard = ({ book }) => {
    ...
    return (
        <div className='flex items-center gap-10 border border-gray-200 p-10 rounded-lg shadow-md'>
            <div className='bg-gray-200  w-60 h-60 flex items-center justify-center rounded-lg'>
            ...
            <div className='space-y-5 w-full'>
                ...
                <div className='flex gap-5 border-b-2  border-gray-300 pb-5 '>
